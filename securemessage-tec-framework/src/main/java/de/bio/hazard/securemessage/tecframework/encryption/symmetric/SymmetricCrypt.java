...
public class SymmetricCrypt {
	...
	public SymmetricCrypt() throws NoSuchAlgorithmException,
	...
	public byte[] decrypt(byte[] data, byte[] key) throws InvalidKeyException,
			IllegalBlockSizeException, BadPaddingException {
		return innerCrypt(data, key, Cipher.DECRYPT_MODE);
	}

	private byte[] innerCrypt(byte[] data, byte[] key, int mode)
			throws IllegalBlockSizeException, BadPaddingException,
			InvalidKeyException {
